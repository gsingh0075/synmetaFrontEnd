                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-sm-2">
                    ...
                    <div class="col margin-60px-bottom sm-margin-30px-bottom xs-margin-40px-bottom wow animate__fadeIn">
                        <div class="feature-box feature-box-left-icon">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin">
                                ...
                                <p>We could achieve effective cross functionality by our robust teamwork. We consider that, each IT project’s success is majorly dependent on the people and their skills set.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col margin-60px-bottom sm-margin-30px-bottom xs-margin-40px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        <div class="feature-box feature-box-left-icon">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin">
                                <span class="alt-font font-weight-500 margin-10px-bottom d-block text-extra-dark-gray">Teams</span>
                                <p>It is only by balancing effectively the resources available we can assure timely project delivery.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end feature box item -->
                    ...
                    <div class="col xs-margin-40px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                        <div class="feature-box feature-box-left-icon">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin">
                                <span class="alt-font font-weight-500 margin-10px-bottom d-block text-extra-dark-gray">Quality</span>
                                <p>SynMeta’s quality, cost-effective and value-driven IT solutions are based on the premise that technology innovation and domain competency.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end feature box item -->

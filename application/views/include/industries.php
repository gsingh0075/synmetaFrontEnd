    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center margin-5-rem-bottom md-margin-5-rem-bottom">
                <span class="d-inline-block alt-font text-medium text-gradient-sky-blue-pink text-uppercase font-weight-500 margin-20px-bottom sm-margin-15px-bottom">Our Industries</span>
            </div>
            <div class="col-12 tab-style-01 without-number wow animate__fadeIn">
                ...
                <?php $j=1; foreach($industries as $ft):?>
